...
It's a top down 2D pixel game with simple WASD/arrow keys to move, E/Enter to interact, and 'F' to full screen. It takes about ten minutes to play if you explore every detail and read the dialogue of every character.  

This EXE file of The Pink Castle has been packaged as an installer, and should run on Windows, Mac, and Ubuntu, but was tested on Windows. 
